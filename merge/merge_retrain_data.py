...
# Load CSV files
racecards = pd.read_csv(os.path.join(DATA_DIR, 'daily_racecard.csv'), low_memory=False)
...
historical_position = pd.read_csv(os.path.join(DATA_DIR, 'todays_position.csv'))
...
output_file = os.path.join(DATA_DIR, 'merged_retrain.csv')
