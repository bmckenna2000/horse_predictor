...
# Load CSV files
racecards = pd.read_csv(os.path.join(DATA_DIR, 'daily_racecard.csv'))
print("Columns in racecards:", racecards.columns.tolist())  # Debug: Check columns
...
# --- Merge DataFrames ---
# Note: Adjust merge keys based on actual column names from debug output
...
output_file = os.path.join(DATA_DIR, 'merged_daily_racecard.csv')
